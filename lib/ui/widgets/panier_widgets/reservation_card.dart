...
class _ReservationCardState extends State<ReservationCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<Partner?>(
      future: PartnersService.getPartnerById(widget.reservation.course.partnerId) ,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    //Displaying place
                    Text(snapshot.data!.name, style: TextStyle(color: Colors.white, fontSize: 15)),
                    SizedBox(height: 7,),
                      ...
                      children: [
                        ...
                        PriceWidget(
                            text: widget.reservation.course.daypassOnly != 1
                                ...
                                : snapshot.data!.passPrice.toStringAsFixed(2),
